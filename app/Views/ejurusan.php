  ...
  <div class="container">
    <div class="col-lg-12 col-12 mt-5 mb-4 mb-lg-4">
      <div class="d-flex flex-column" style="background-color: #FAF5F1; padding: 2rem; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); color: #292F36;">
        ...
        <h3 style="color: #292F36; font-weight: bold; margin-bottom: 1.5rem;">Edit Jurusan</h3>

        <form action="<?= base_url('/simpanjurusan') ?>" method="POST">
          <?= csrf_field() ?>
          <table style="width: 100%;">
            <tr>
              <td style="padding-bottom: 10px;"><label for="nama_jurusan" style="font-weight: 500; color: #292F36;">Nama Jurusan</label></td>
              <td style="padding-bottom: 10px;">
                <input type="text" class="form-control" id="nama_jurusan" name="nama_jurusan" value="<?= $jurusan->nama_jurusan ?>" style="border: 1px solid #8F7A6E; border-radius: 8px; padding: 0.6rem; width: 100%;" required>
              </td>
            </tr>
            <tr>
              <td></td>
